...
def send_message(to_user, access_token, region_name, weather, temp, wind_dir, note_ch, max_temperature,
    ...
    for key, value in birthdays.items():
        ...
        if birth_day == 0:
            ...
            birthday_data = "{}".format(birth_day)
        # 将生日数据插入data
        data["data"][key] = {"value": birthday_data, "color": 0xFAEDAA}
    headers = {
...
if __name__ == "__main__":
    ...
    # 公众号推送消息
    for user in users:
        send_message(user, accessToken, region, weather, temp, wind_dir,  note_ch,max_temperature,
                     min_temperature, humidity1, air_quality, air_data)
    os.system("pause")
